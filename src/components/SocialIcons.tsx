// Icônes des réseaux sociaux en SVG inline, style "stroke" cohérent
// (lucide-react 1.x ne fournit plus les icônes de marque Instagram /
...
export function WhatsappIcon({ size = 20, className }: IconProps) {
  return (
    <svg {...svgProps(size, className)}>
      ...
      {/* Combiné téléphonique, réduit et centré */}
